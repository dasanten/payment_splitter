...
class PaymentData with UserIdentificationMixin {
  PaymentData();
  ...
  double get highestPayment => users
      .map((user) => user.originalPayment)
  ...
  double get averagePayment => totalPayment / users.length;
}
